            ...
            _.initials = {
                ...
                dates: {
					...
					ar: {
                        ...
                        months: ["يناير", "فبرياير", "مارس", "أبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"],
                        monthsShort: ["يناير", "فبرياير", "مارس", "أبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"],
                        noEventForToday: ".. لذا خذ قسطا من الراحة :)",
                        noEventForThisDay: ".. لذا خذ قسطا من الراحة :)",
                        previousYearText: "السنة الماضية",
                        nextYearText: "العام القادم",
                        closeSidebarText: "إغلاق الشريط الجانبي",
                        closeEventListText: "إغلاق قائمة الأحداث"
                    },
                    es: {
